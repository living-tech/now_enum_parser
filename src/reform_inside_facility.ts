...
const translations: Translations = {
  ja: {
    [ReformInsideFacility.OverallInterior]:
      '内装全面（床、壁、天井、建具すべて）', // 1:内装全面（床、壁、天井、建具すべて） 2:壁、天井（クロス、塗装等） 3:全室クロス張替 4:床（フローリング等） 5:建具（室内ドア等） 6:サッシ
  ...
  en: {
    [ReformInsideFacility.OverallInterior]: 'Overall interior',
...
// Edit constants name
export const reformInsideFacilityEncoder = generateEncoder<
  ReformInsideFacility
>(translations);
export const reformInsideFacilityDecoder = generateDecoder<
  ReformInsideFacility
>(reverseTranslations);
