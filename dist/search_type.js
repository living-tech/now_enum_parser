...
var translations = {
    ja: (_a = {},
        ...
        _a[SearchType.SearchByTime] = '通勤時間・通勤距離から探す',
        _a),
    en: (_b = {},
...
// Edit constants name
exports.searchTypeEncoder = (0, generators_1.generateEncoder)(translations);
exports.searchTypeDecoder = (0, generators_1.generateDecoder)(reverseTranslations);
