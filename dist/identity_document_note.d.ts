...
export declare const identityDocumentNoteEncoder: (raw: IdentityDocumentNote, lang: import(".").Language) => string;
export declare const identityDocumentNoteDecoder: (text: string, lang: import(".").Language) => IdentityDocumentNote;
