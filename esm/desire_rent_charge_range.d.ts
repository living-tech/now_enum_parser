...
export declare const desireRentChargeRangeEncoder: (raw: DesireRentChargeRange, lang: import("./index").Language) => string;
export declare const desireRentChargeRangeDecoder: (text: string, lang: import("./index").Language) => DesireRentChargeRange;
