...
export declare const employmentStatusEncoder: (raw: EmploymentStatus, lang: import("./index").Language) => string;
export declare const employmentStatusDecoder: (text: string, lang: import("./index").Language) => EmploymentStatus;
