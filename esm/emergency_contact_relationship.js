...
// Edit constants name
export var emergencyContactRelationshipEncoder = generateEncoder(translations);
export var emergencyContactRelationshipDecoder = generateDecoder(reverseTranslations);
