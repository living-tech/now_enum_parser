...
export declare const imageTargetEncoder: (raw: ImageTarget, lang: import("./index").Language) => string;
export declare const imageTargetDecoder: (text: string, lang: import("./index").Language) => ImageTarget;
