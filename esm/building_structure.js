...
// Edit constants name
export var buildingStructureEncoder = generateEncoder(translations);
export var buildingStructureDecoder = generateDecoder(reverseTranslations);
