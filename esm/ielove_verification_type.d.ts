...
export declare const ieloveVerificationTypeEncoder: (raw: IeloveVerificationType, lang: import("./index").Language) => string;
export declare const ieloveVerificationTypeDecoder: (text: string, lang: import("./index").Language) => IeloveVerificationType;
