...
// Edit constants name
export var reserveStatusEncoder = generateEncoder(translations);
export var reserveStatusDecoder = generateDecoder(reverseTranslations);
