...
export var CertificateImageType;
...
// Edit constants name
export var certificateImageTypeEncoder = generateEncoder(translations);
export var certificateImageTypeDecoder = generateDecoder(reverseTranslations);
