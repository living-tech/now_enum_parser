...
export var IdentityDocumentNote;
...
})(IdentityDocumentNote || (IdentityDocumentNote = {}));
// Edit contexts
var translations = {
    ja: (_a = {},
...
// Edit constants name
export var identityDocumentNoteEncoder = generateEncoder(translations);
export var identityDocumentNoteDecoder = generateDecoder(reverseTranslations);
