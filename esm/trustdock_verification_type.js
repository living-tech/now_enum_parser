...
export var TrustdockVerificationType;
...
})(TrustdockVerificationType || (TrustdockVerificationType = {}));
// Edit contexts
var translations = {
    ja: (_a = {},
...
// Edit constants name
export var trustdockVerificationTypeEncoder = generateEncoder(translations);
export var trustdockVerificationTypeDecoder = generateDecoder(reverseTranslations);
